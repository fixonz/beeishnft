...
function MultiStepReveal(_a) {
    ...
    return (React.createElement("div", { className: "flex flex-col items-center" },
        ...
        showStepModal && (React.createElement("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/80" },
            React.createElement("div", { className: "relative w-[85vw] h-[85vw] sm:w-[70vw] sm:h-[70vw] md:w-[45vw] md:h-[45vw] lg:w-[35vw] lg:h-[35vw] xl:w-[30vw] xl:h-[30vw] max-w-[90vw] max-h-[90vh] aspect-square flex items-center justify-center bg-[#FFB949] border-8 border-[#3A1F16] rounded-lg shadow-2xl overflow-hidden" },
                React.createElement("div", { className: "relative w-full h-full" },
                    React.createElement("div", { className: "absolute inset-0 flex items-center justify-center p-4" },
                        React.createElement(image_1["default"], { src: revealedImage || unrevealedImageUrl, alt: "NFT to reveal", fill: true, sizes: "100%", style: { objectFit: "contain" }, priority: true })),
                    React.createElement("div", { className: "absolute inset-0 flex items-center justify-center p-4" },
                        React.createElement(image_1["default"], { src: overlayGifs[modalStep], alt: "Reveal overlay " + (modalStep + 1), fill: true, sizes: "100%", style: { objectFit: "contain" }, priority: true })))))),
        showRevealedModal && revealedImage && (React.createElement("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/80" },
            React.createElement("div", { className: "bg-[#FFB949] border-8 border-[#3A1F16] rounded-lg shadow-2xl p-4 flex flex-col items-center w-[60vw] sm:w-[45vw] md:w-[30vw] lg:w-[20vw] xl:w-[15vw] max-w-[90vw] max-h-[90vh] relative" },
                ...
                React.createElement("h3", { className: "text-lg font-bold text-[#3A1F16] mb-3" }, "Your Bee is Revealed!"),
                React.createElement("div", { className: "w-full h-auto relative" },
                    React.createElement(image_1["default"], { src: revealedImage, alt: "Revealed NFT", width: 200, height: 200, className: "object-contain rounded-lg border-4 border-[#3A1F16] bg-white mx-auto" })))))));
}
