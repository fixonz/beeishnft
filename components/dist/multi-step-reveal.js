...
function MultiStepReveal(_a) {
    ...
    return (React.createElement("div", { className: "flex flex-col items-center" },
        ...
        React.createElement("div", { className: "flex gap-6 justify-center mb-6 w-full" }, buttonLabels.map(function (label, idx) { return (React.createElement(custom_button_1["default"], { key: label, variant: idx === step ? "mint" : "blank", className: "min-w-[140px] py-3 text-lg w-full", onClick: handleStep, disabled: step !== idx || isLoading || !!revealedImage }, label)); })),
        React.createElement(custom_button_1["default"], { variant: "blank", className: "w-[140px] py-3 text-lg", onClick: handleCancel, disabled: isLoading }, "Cancel"),
