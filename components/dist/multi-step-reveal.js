...
function MultiStepReveal(_a) {
    ...
    return (React.createElement("div", { className: "flex flex-col items-center" },
        ...
        React.createElement("div", { className: "w-full flex flex-col md:flex-row gap-6 mb-6" },
            ...
            React.createElement("div", { className: "w-full md:w-1/2 border-4 border-[#3A1F16] rounded-lg p-4 bg-[#fff3d4] flex flex-col justify-center" },
                ...
                React.createElement("div", { className: "grid grid-cols-1 gap-4" },
                    buttonLabels.map(function (label, idx) { return (React.createElement(custom_button_1["default"], { key: label, variant: idx === step ? "mint" : "blank", className: "py-4 text-xl font-bold " + (idx === step ? "border-4 border-[#3A1F16] shadow-lg transform scale-105" : ""), onClick: handleStep, disabled: step !== idx || isLoading || !!revealedImage }, label)); }),
                    React.createElement(custom_button_1["default"], { variant: "blank", className: "py-3 text-lg mt-2", onClick: handleCancel, disabled: isLoading }, "Cancel")),
