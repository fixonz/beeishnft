...
function MultiStepReveal(_a) {
    ...
    return (React.createElement("div", { className: "flex flex-col items-center" },
        ...
        React.createElement("h2", { className: "text-2xl font-bold text-center mb-4 text-[#3A1F16]" }, "Free Your Bee!"),
        React.createElement("div", { className: "flex w-full max-w-[600px] mx-auto justify-center" },
            React.createElement("div", { className: "w-[220px] h-[220px] mr-4 border-4 border-[#3A1F16] rounded-lg bg-white overflow-hidden" },
            ...
            React.createElement("div", { className: "w-[220px] border-4 border-[#3A1F16] rounded-lg p-4 bg-[#FFF8E1]" },
                React.createElement("h3", { className: "text-center font-bold text-lg text-[#3A1F16] mb-4" },
                    "Step ",
                    step + 1,
                    " of 3: ",
                    buttonLabels[step]),
                React.createElement("div", { className: "flex flex-col gap-3" },
                    React.createElement(custom_button_1["default"], { variant: "mint", className: "py-2 font-bold " + (step === 0 ? "" : "opacity-50"), onClick: handleStep, disabled: step !== 0 || isLoading || !!revealedImage }, "Shoot the Hive"),
                    React.createElement(custom_button_1["default"], { variant: "blank", className: "py-2 font-bold " + (step === 1 ? "" : "opacity-50"), onClick: handleStep, disabled: step !== 1 || isLoading || !!revealedImage }, "SHooT"),
                    React.createElement(custom_button_1["default"], { variant: "blank", className: "py-2 font-bold " + (step === 2 ? "" : "opacity-50"), onClick: handleStep, disabled: step !== 2 || isLoading || !!revealedImage }, "Reveal"),
                    React.createElement(custom_button_1["default"], { variant: "blank", className: "py-2 mt-2", onClick: handleCancel, disabled: isLoading }, "Cancel")),
                error && React.createElement("p", { className: "text-red-500 mt-4 font-bold text-center" }, error))),
