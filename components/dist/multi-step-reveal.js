...
function MultiStepReveal(_a) {
    ...
    return (React.createElement("div", { className: "flex flex-col items-center" },
        ...
        showStepModal && (React.createElement("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/70" },
            React.createElement("div", { className: "relative w-[85vw] h-[85vw] max-w-[90vw] max-h-[90vh] aspect-square flex items-center justify-center bg-white rounded-lg shadow-lg p-4" },
