...
// Remove whitelist service import
...
export default function MintModal({ open, onClose }: MintModalProps) {
  ...
  // Remove whitelist state variables
  ...
  // Remove whitelist checking useEffect
        ...
        <div className="p-4 md:p-6 flex flex-col items-center">
          ...
          {!success ? (
            <div className="grid gap-4 py-2 md:py-4">
              ...
              {/* Remove whitelist check UI components */}
          ...
          <div className="flex justify-between mt-4 md:mt-6 w-full">
            {!success ? (
              <>
                ...
                <div 
                  onClick={handleMint} 
                  className={`cursor-pointer ${minting ? "opacity-70" : ""}`}
                >
                  {minting ? (
                    <div
